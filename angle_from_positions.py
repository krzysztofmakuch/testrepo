...
!!!! WARNING !!!!!
The xvg you did with trjconv HAS TO BE DONE ON WHOLE MOLS. That's
because if you don't use -pbc whole or -pbc mol, atoms between which
vectors are calculated can be at the opposite sides of the box.

For example the example below works with data in
'lut_ver_vector_C1320.xvg', 3-dimensions (xyz) and assumes there are
data for 6 molecules in the following columns. So 37 columns
alltogether (column 0 for time and 2x3x6=36 columns with data):
